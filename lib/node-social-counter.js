(function() {
  ...
  getFacebookCount = function(key, target_url){
    ...
    if(typeof requestsInProgress[key].facebook === 'undefined' && requestsInProgress[key].fb_hits >= config.facebook.fb_hits_required){
        ...
        timeout: config.facebook.fb_timeout*1000,
          ...
          if (err) { // request error handling
            ...
            if(typeof body.shares !== 'undefined'){
              ...
              delete requestsInProgress[key].fb_hits;
    ...
    for (var key in requestsInProgress){
      if (requestsInProgress.hasOwnProperty(key)) {
        ...
        if(typeof requestsInProgress[key].facebook === 'number'){    
          ...
          if(expired){
            delete requestsInProgress[key].fb_hits; // remove from queue
